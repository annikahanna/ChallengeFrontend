...
export class DefaultService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public registerVenturer(body?: Venturer, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public registerVenturer(body?: Venturer, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public registerVenturer(body?: Venturer, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public registerVenturer(body?: Venturer, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.basePath}/api/venturer/register`,
            body,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
